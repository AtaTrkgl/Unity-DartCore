...
namespace DartCore.UI
{
    ...
    public class SwitchEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("isInteractive"), new GUIContent("Is Interactive"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("OnToggle"), new GUIContent("On Toggle"));

            EditorGUILayout.PropertyField(serializedObject.FindProperty("normalColor"), new GUIContent("Normal Stroke Color"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("highlightedColor"), new GUIContent("Highlighted Stroke Color"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("disabledColor"), new GUIContent("Disabled Stroke Color"));
